...
if (isset($_POST['class_name']) && isset($_POST['year']) && isset($_POST['section']) && isset($_POST['subject']) && isset($_POST['course_id'])) {
    ...
    $sql = "INSERT INTO class (course_id, code, class_name, year, section, subject, faculty_id) VALUES ('$course_id', '$unique_code', '$class_name', '$year', '$section', '$subject', '$faculty_id')";
