    ...
    <body>
        ...
        ?>  
                        <div class="notification-card" data-administer-id="<?php echo $row['administer_id']; ?>" data-student-id="<?php echo $row['student_id']; ?>">
                            ...
                            <?php if ($row['max_warnings'] > $row['suspicious_act']) {?>
                            ...
                            <?php } else { ?>
                                <div> <?php echo htmlspecialchars($row['student_name']); ?> has performed a suspicious activity (<?php echo htmlspecialchars($row['method']);?>). They have 0 warnings left. </div>
                            <?php } ?>
