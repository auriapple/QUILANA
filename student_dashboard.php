        ...
        <div class="content-wrapper dashboard-container">
            ...
            <div class="dashboard-summary">
                ...
                <div class="cards">
                    ...
                    <div class="card" style="background-color: #FADEFF; cursor: pointer;" onclick="window.location.href='enroll.php';"> 
                    ...
                    <div class="card" style="background-color: #DCE1FC; cursor: pointer;" onclick="window.location.href='enroll.php';"> 
